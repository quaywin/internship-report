...
J'ai effectué mon stage à SMARTESTING à Besançon.Cette société, anciennement LEIROS a été créée en 2003 par Laurent PY et Bruno LEGEARD est devenue SMARTESTING en juin 2008. Elle est issue du projet Smart Testing\texttrademark ~à l'université de Franche Comté. L'objectif premier de SMARTESTING a été d'industrialiser le projet Smart Testing\texttrademark . Diverses améliorations ont ensuite été apportées au produit, mais j'y reviendrai un peu plus tard.

\subsection{Secteur d'activité}
Smartesting développe dans le secteur grandissant du test logiciel. Ce marché devrait atteindre 13 milliards de dollars en 2010 (selon une étude de Gartner). Le test logiciel, en particulier le test fonctionnel devient une phase clé du développement logiciel. Des besoins très stricts pour les milieux bancaires par exemple obligent ces entreprises à faire appel à des ingénieurs et des architectes de test afin de concevoir les tests logiciels qui permettront par exemple de garantir la stabilité, la non regression et le bon fonctionnement de gros projets.

\subsection{Couverture géographique}
Smartesting est implantée dans différents points stratégiques. En France,le siège social ainsi que le centre R\&D sont \`a Besançon dans les locaux de l'h\^otel d'entreprises TEMIS Innovation. Ainsi la R\&D reste proche géographiquement de l'université et de la recherche qui y a lieu.
...
\end{figure}
Je travaille dans le service de recherche et développement de Smartesting. Le produit Test Designer ainsi que les connecteurs et les publishers y sont développés. Je parlerai en détail ultérieurement de ces aspects du produit. L'équipe est composée de 10 développeurs ainsi que d'un
