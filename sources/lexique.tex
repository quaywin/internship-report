...
\section{Road-map}
TODO
La road-map est une planification des tâches à effectuer pour les différents jalons à venir. Elle es faite par le client XP ainsi que les _________ lors du _______ game.
